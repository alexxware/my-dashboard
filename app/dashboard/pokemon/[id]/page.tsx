...
function capitalizarPrimeraLetra(texto: string): string {
    if (!texto) return texto; // Maneja strings vacíos
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const nameFormatted = capitalizarPrimeraLetra(pokemonInfo.name);

    return {
        title: nameFormatted,
        description: 'Informatio about the pokemon ' + pokemonInfo.name
    }
}
